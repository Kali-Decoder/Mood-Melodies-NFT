      ...
      <header className="fixed left-0 top-0 md:ml-64 w-full md:w-[calc(100%-256px)] bg-[#0A0A0A]/90 flex items-center justify-between p-4 z-40">
        ...
        <div className="flex items-center gap-6">
          ...
          >
            ...
            <span className="text-yellow-500 mx-2">{address.toString().slice(0,5)+ "..." + address.toString().slice(38)}</span>  Disconnect Wallet
          </button> : <button
            type="button"
      ...
      {open && (
        <div className="fixed  flex justify-center items-center top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
          <div className="relative w-full max-w-md max-h-full ">
            <div className="relative bg-[#0A0A0A]/90 rounded-lg shadow dark:bg-[#0A0A0A]/90">
              <button
                type="button"
